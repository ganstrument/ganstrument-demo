//Reference from : https://github.com/beforesemicolon/BFS-Projects/tree/audio-player-tag
{
  class AudioPlayer extends HTMLElement {
    ...
    updateFrequency() {
      ...
      // const color = this.progressBar.value * 10
      // console.log(color)
      ...
      for (let i = 0; i < barCount; i++) {
        ...
        this.canvasCtx.fillStyle = `rgba(${color}, 255, 100)`;
        this.canvasCtx.fillRect(0, 0, this.canvas.width, this.canvas.height);
